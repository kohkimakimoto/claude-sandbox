...
VERSION := 2.0.0
BUILD_LDFLAGS = "-s -w -X github.com/kohkimakimoto/claude-sandbox/v2/internal/version.CommitHash=$(COMMIT_HASH) -X github.com/kohkimakimoto/claude-sandbox/v2/internal/version.Version=$(VERSION)"
